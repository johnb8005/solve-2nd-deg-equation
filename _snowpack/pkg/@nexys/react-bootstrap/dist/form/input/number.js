...
const InputNumber = ({ value, onChange, errors, disabled, placeholder, }) => (react_1.default.createElement("input", { className: "form-control" + (errors && errors.length > 0 ? "  is-invalid" : ""), disabled: disabled, placeholder: placeholder, type: "number", value: isNaN(Number(value)) ? "" : value, onChange: (v) => v.target.value === ""
        ? onChange(undefined)
